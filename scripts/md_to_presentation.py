...
def convert(md_text: str) -> str:
    ...
    slide_titles = [
        ...
        ("Il Dominio Si Codifica", "Paper, formule, vincoli, errori"),
        ("Tre Livelli di Conoscenza", "Dati, Metodo, Giudizio"),
        ("Compliance Come Dominio", "8 ambiti normativi"),
